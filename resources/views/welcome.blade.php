...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Centro de Asistencia-Parquesoft</title>
    ...
    <body class="bg-lime-400">
       ...
       <div class="mt-32"></div> 
        ...
        <img class="mx-auto h-auto max-w-full rounded-lg" src="../public/img/centro.png" alt="image description">
        <div class="mt-12"></div>
        <form class="flex items-center w-full md:w-auto" style="width: 596px; margin-left: 471px;">   
